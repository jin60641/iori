				...
				current.save( function( err2 ){
					if( err2 ){
						...
						smtpTransport.sendMail({
							...
							html : require("./mailconfig").mailTemplate('안녕하세요. iori.kr입니다.<br>회원가입을 위한 이메일 인증을 위해 아래의 링크를 클릭해>주세요.<br><a href="' + string + '" style="display : block; margin-top : 20px; text-decoration:none;color:rgb(255,92,62);font-weight:bold;">여기를 눌러 이메일 인증</a><br>인증이 완료되면 정상적으로 서비스 이용이 가능합니다.<br>감사합니다.<br>오늘도 좋은 하루되세요.<br>iori.kr 운영진 드림.')
